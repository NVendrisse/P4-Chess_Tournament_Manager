...
'''
foreground = {"black": "\033[30m", "red": "\033[31m", "green": "\033[32m", "yellow": "\033[33m", "blue": "\033[34m", "magenta": "\033[35m",
...
background = {"black": "\033[40m", "red": "\033[41m", "green": "\033[42m", "yellow": "\033[43m", "blue": "\033[44m", "magenta": "\033[45m",
              "cyan": "\033[46m", "white": "\033[47m", "gray": "\033[100m",
              "bright_red": "\033[101m", "bright_green": "\033[102m", "bright_yellow": "\033[103m", "bright_blue": "\033[104m",
              "bright_magenta": "\033[105m", "bright_cyan": "\033[106m", "bright_white": "\033[107m"}
effect = {
    "None": "",
    "bold": "\033[1m",
    "italic": "\033[3m",
...
def cprint(value, foreground_color="bright_white", background_color="black", attribute="None", eol="\n"):
    try:
        print(foreground[foreground_color]+background[background_color] +
              effect[attribute]+"{}".format(value)+"\033[0m", end=eol)
    except ValueError:
